 ...
 *   Input.endFrame();
 *
 * USAGE in a single-file Artifact:
 *   Just paste this whole `const Input = ...` block at the top
 *   of the <script> tag and use it the same way.
 * ============================================================ */
